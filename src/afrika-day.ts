const info: { title: string, text: string[] } = {
    ...
    text: [
        ...
        '<b>A rendezvényre a belépés ingyenes, de regisztrációhoz kötött!</b>',
        'Részletes programterv hamarosan elérhető lesz honlapunkon!',
        'További információért és regisztrációért keress minket a <a href="mailto:szivembenszuletettafrika@szivembenafrika.org">szivembenszuletettafrika@szivembenafrika.org</a> email címen.',
