const info: { title: string, text: any } = {
    title: 'NEMZETKÖZI AFRIKA NAP - 2022.05.25.',
    text: {
        intro: '1963 óta ünnepeljük május 25-én világszerte az Afrika napot. Ennek apropójából egy egész napos eseményre hívjuk az afrikai kultúra iránt érdeklődőket. A program saját szervezés útján valósul meg, partnerünkkel, a Márai Sándor Művelődési Ház támogatásával.',
        detailsLink: `<a href="#/nemzetkozi-afrika-nap/programok">Részletes programterv itt!</a>`,
        desc: [
            ...
            '<b>A rendezvényre a belépés ingyenes! A délelőtti program regisztrációhoz kötött, melyet a <a href="mailto:szivembenszuletettafrika@szivembenafrika.org">szivembenszuletettafrika@szivembenafrika.org</a> email címen keresztül tehetnek meg az érdeklődők.</b>',
            'További információért keress minket a <a href="mailto:szivembenszuletettafrika@szivembenafrika.org">szivembenszuletettafrika@szivembenafrika.org</a> email címen.',    
        ],
        sponsor: [
            'Néhány szó a rendezvény legnagyobb támogatójáról, a Márai Sándor Művelődési Házról, akik a helyszínt biztosítják, hogy a téma színvonalához méltó helyen tarthassuk meg a programot, valamint, hogy minél több érdeklődőnek lehetőséget adhassunk az esemény látogatására:',
